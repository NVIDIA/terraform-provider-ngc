		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testCloudFunctionDatasourceFullPath, "inference_url", testutils.TestContainerEndpoint),
					resource.TestCheckResourceAttr(testCloudFunctionDatasourceFullPath, "health_uri", testutils.TestContainerHealthEndpoint),
